...
<body>
<div style="width: 100%; height: 100px; background: blue; text-align: center; font-size: 30px; color: white;">
Wellcome to admin pannel
	</div>
	wellcome:<font size='8px' color="red">
	...
	<table width="1000px" border="2px" align="center">
		...
		?>
			...
			<td><a href="delete.php?del_page=<?php echo $p_id; ?>">Delete Page</a></td>
		</tr>
...
?>
	<table width="400px" border="3px" align="center">
		...
		?>
			...
			<td><a href="delete.php?del_menu=<?php echo $m_id; ?>">Delete Menu</a></td>
		</tr>
		<?php } } ?>
		</table>
